...
ולא בקשה חד-פעמית. שלושה סייגים שגוברים עליו, כולם מ-`CLAUDE.md`:

- **ארבע הסוויטות רצות במלואן לפני כל דחיפה ל-`main`.** "מינימום טוקנים" אינו
  עילה לדלג על סוויטה, לקצר הרצה, או להסיק שמשהו עובר בלי להריץ אותו.
- **תיעוד אינו פטפוט.** `CLAUDE.md` מתעדכן עם השינוי כשהוא משנה כלל או הכרעה.
  מה שנחתך הוא הנרטיב בצ׳אט, לא ההכרעה בקובץ.
- **בעל הריפו מקבל סיכום קצר בעברית בסוף כל משימה** — מה נעשה, מה נבדק, ומה
  עליו לעשות (למשל לפרוס את הגשר מחדש). "Silent completion" חל על שלבי ביניים,
  לא על הדיווח הסופי.
