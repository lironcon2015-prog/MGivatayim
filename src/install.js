...
const IOS = `<ol class="steps">
    <li>פותחים את הקישור ב-<b>Safari</b>. נפתח בתוך וואטסאפ? לוחצים על סמל המצפן או על ⋯ ← <b>"פתיחה ב-Safari"</b>.</li>
...
const ANDROID = `<ol class="steps">
    <li>פותחים את הקישור ב-<b>Chrome</b>. נפתח בתוך וואטסאפ? לוחצים על ⋮ ← <b>"פתיחה ב-Chrome"</b>.</li>
